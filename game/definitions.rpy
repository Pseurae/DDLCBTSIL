...
init python:
    ...
    def get_remaining_time(channel='music'):
        pos = renpy.music.get_pos(channel=channel)
        duration = renpy.music.get_duration(channel=channel)
        if pos and duration:
            return duration - pos
        return 0
...
define s = DynamicCharacter('s_name', image='sayori', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(3, '#74d1fa', 0, 0), (1, '#74d1fa', 1, 1)])
define m = DynamicCharacter('m_name', image='monika', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(3, '#80c742', 0, 0), (1, '#80c742', 1, 1)])
define n = DynamicCharacter('n_name', image='natsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(3, '#ed9fa9', 0, 0), (1, '#ed9fa9', 1, 1)])
define y = DynamicCharacter('y_name', image='yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(3, '#cf88f6', 0, 0), (1, '#cf88f6', 1, 1)])
